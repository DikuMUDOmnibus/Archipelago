...
#define MAX_CMD_LIST	650

#define ACMD(c)  \
   void (c)(struct char_data *ch,char *argument,int cmd,int subcmd)
#define CRYPT(a,b) ((char *) crypt((a),(b))) 
#define SPECIAL(c) int (c)(struct char_data *ch, void *me, int cmd, char *arg)
...
int     search_list(char *arg, struct list_index_type *list, bool extact);
...
#define SCMD_NOBRAG     216
#define SCMD_NOCOND     217   
